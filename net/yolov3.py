...
class YoloV3:
    ...
    def __init__(self, is_training=False):
        ...
        self.use_label_smooth = setting.use_label_smooth  #
        self.use_focal_loss = setting.use_focal_loss
        self.weight_decay = setting.weight_decay
        self.use_static_shape = setting.use_static_shape
        self.freeze_body = True  # 冻结，切换至 Darknet-19
        self.is_training = is_training
        self.reuse = setting.reuse
        self.batch_norm_params = {
            'decay': setting.batch_norm_decay,  # BN衰减系数
            'epsilon': 1e-05,
            'scale': True,
        ...
        with slim.arg_scope([slim.conv2d, slim.batch_norm], reuse=self.reuse):
            with slim.arg_scope(
                ...
                with tf.variable_scope('yolov3_head'):
                    ...
                    self.feature_map_1, self.feature_map_2, self.feature_map_3 = detect_net(route_1, route_2, route_3)
    ...
    def _predict(self):
        ...
        self.boxes, self.scores, self.labels = gpu_nms(
            ...
            score_thresh=setting.score_threshold, nms_thresh=setting.nms_threshold
        )
    ...
    def compute_loss(self, y_pred, y_true):
        """
        计算损失
        :param y_pred: returned feature_map list by `forward` function: [feature_map_1, feature_map_2, feature_map_3]
